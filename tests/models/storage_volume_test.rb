...
describe DeltacloudVM::Client::StorageVolume do
  ...
  it 'supports #snapshot!' do
    vol = @client.storage_volume('vol1')
    vol.snapshot!.must_be_instance_of DeltacloudVM::Client::StorageSnapshot
  end
  ...
  it 'supports #instance' do
    ...
    vol.attach('inst1')
    vol.attached?.must_equal true
    vol.instance.must_be_instance_of DeltacloudVM::Client::Instance
