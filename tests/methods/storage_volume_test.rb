...
describe DeltacloudVM::Client::Methods::StorageVolume do
  ...
  it 'supports #storage_volumes' do
    ...
    @client.storage_volumes.each { |r| r.must_be_instance_of DeltacloudVM::Client::StorageVolume }
  end
  ...
  it 'supports filtering #storage_volumes by :id param' do
    ...
    result.first.must_be_instance_of DeltacloudVM::Client::StorageVolume
  ...
  it 'support #storage_volume' do
    ...
    result.must_be_instance_of DeltacloudVM::Client::StorageVolume
    lambda { @client.storage_volume(nil) }.must_raise DeltacloudVM::Client::NotFound
    lambda { @client.storage_volume('foo') }.must_raise DeltacloudVM::Client::NotFound
  end
  ...
  it 'support #create_volume and #destroy_volume' do
    ...
    lambda { @client.storage_volume(result._id) }.must_raise DeltacloudVM::Client::NotFound
  end
