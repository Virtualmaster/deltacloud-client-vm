...
describe DeltacloudVM::Client::Methods::Address do
  ...
  it 'supports #addresses' do
    ...
    @client.addresses.each { |r| r.must_be_instance_of DeltacloudVM::Client::Address }
  end
  ...
  it 'supports filtering #addresses by :id param' do
    ...
    result.first.must_be_instance_of DeltacloudVM::Client::Address
  ...
  it 'support #address' do
    ...
    result.must_be_instance_of DeltacloudVM::Client::Address
    lambda { @client.address(nil) }.must_raise DeltacloudVM::Client::NotFound
    lambda { @client.address('foo') }.must_raise DeltacloudVM::Client::NotFound
  end
  ...
  it 'support #create_address' do
    ...
    lambda { @client.address(result._id) }.must_raise DeltacloudVM::Client::NotFound
  end
