...
describe DeltacloudVM::Client::Methods::Key do
  ...
  it 'supports #keys' do
    ...
    @client.keys.each { |r| r.must_be_instance_of DeltacloudVM::Client::Key }
  end
  ...
  it 'supports filtering #keys by :id param' do
    ...
    result.first.must_be_instance_of DeltacloudVM::Client::Key
  ...
  it 'support #key' do
    ...
    result.must_be_instance_of DeltacloudVM::Client::Key
    lambda { @client.key(nil) }.must_raise DeltacloudVM::Client::NotFound
    lambda { @client.key('foo') }.must_raise DeltacloudVM::Client::NotFound
  end
